	...
	return (
		<div className='flex flex-col h-screen bg-black'>
			...
			<div className='flex-grow flex flex-col p-4 md:p-6 lg:p-8 overflow-hidden max-w-4xl mx-auto w-full'>
				<div className='flex items-center mb-4 bg-gray-900 rounded-lg shadow p-3 border border-gray-800'>
					<img
						src={match.image || "/avatar.png"}
						className='w-12 h-12 object-cover rounded-full mr-3 border-2 border-purple-500'
					/>
					<h2 className='text-xl font-semibold text-white'>{match.name}</h2>
				</div>

				<div className='flex-grow overflow-y-auto mb-4 bg-gray-900 rounded-lg shadow p-4 border border-gray-800'>
					{messages.length === 0 ? (
...
const MatchNotFound = () => (
	<div className='h-screen flex flex-col items-center justify-center bg-black'>
		<div className='bg-gray-900 p-8 rounded-lg shadow-md text-center border border-gray-800'>
			<UserX size={64} className='mx-auto text-purple-500 mb-4' />
			...
			<Link
				to='/'
				className='mt-6 px-4 py-2 bg-purple-700 text-white rounded hover:bg-purple-600 transition-colors 
				focus:outline-none focus:ring-2 focus:ring-purple-500 inline-block'
			>
				Go Back To Home
			</Link>
		</div>
...
const LoadingMessagesUI = () => (
	<div className='h-screen flex flex-col items-center justify-center bg-black'>
		<div className='bg-gray-900 p-8 rounded-lg shadow-md text-center border border-gray-800'>
			<Loader size={48} className='mx-auto text-purple-500 animate-spin mb-4' />
