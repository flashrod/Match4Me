		...
		<div className='min-h-screen bg-black flex flex-col'>
			...
			<div className='flex-grow flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8'>
				<div className='sm:mx-auto sm:w-full sm:max-w-md'>
					<h2 className='mt-6 text-center text-3xl font-extrabold text-purple-400'>Your Profile</h2>
				</div>
				...
				<div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
					<div className='bg-gray-900 py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-800'>
						<form onSubmit={handleSubmit} className='space-y-6'>
								...
								<div className='mt-1'>
									<input
										...
										className='appearance-none block w-full px-3 py-2 border border-gray-700
										 rounded-md shadow-sm placeholder-gray-500 bg-gray-800 text-white focus:outline-none focus:ring-purple-500 focus:border-purple-500 
										sm:text-sm'
									/>
								</div>
							</div>
							...
							{/* GENDER PREFERENCE */}
							<div>
								<span className='block text-sm font-medium text-gray-300 mb-2'>Gender Preference</span>
								<div className='flex space-x-4'>
							...
							<div>
								...
								<div className='mt-1 flex items-center'>
									<button
										...
										className='inline-flex items-center px-4 py-2 border border-gray-700 rounded-md shadow-sm text-sm font-medium text-gray-300 bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500'
									>
										Upload Image
									</button>
									<input
							...
							<button
								type='submit'
								className='w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-purple-700 hover:bg-purple-800 
